...
<body>
    <section class="overview overflow-auto">
        ...
        <main class="main-wrapper">
            <div class="ps-lg-0">
                <h2 class="text-4xl fw-bold color-palette-1 mb-30">Costumers</h2>
                <div class="latest-transaction">
                    <p class="text-lg fw-medium color-palette-1 mb-14">Costumers list</p>
                                    ...
                                    <tr class="align-middle">
                                        <th scope="row">
                                            <div class="game-title-header">
                                                <p class="game-title fw-medium text-start color-palette-1 m-0"><?= $account['email'] ?></p>
                                            </div>
                                        </th>
                                        <td>
                                            <div>
                                        ...
                                        <td>
                                            <a href="delete.php?id=<?= $account['id_customer']; ?>" class="btn btn-primary">Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
