...
<body>
    <section class="overview overflow-auto">
        ...
        <main class="main-wrapper">
            <div class="ps-lg-0">
                <h2 class="text-4xl fw-bold color-palette-1 mb-30">Menu's</h2>
                <div class="latest-transaction">
                    <p class="text-lg fw-medium color-palette-1 mb-14">Latest Menu's</p>
                    <a href="../../pages/admin/add-menu.php" class="btn btn-primary">Add New Menu</a>
                    <div class="main-content main-content-table overflow-auto mt-3">
                        <table class="table table-borderless">
                            <thead>
                                <tr class="color-palette-1">
                                    <th class="text-start" scope="col">Menu</th>
                            ...
                            <tbody>
                                <?php foreach ($menus as $menu) : ?>
                                    <tr class="align-middle">
                                        <th scope="row">
                                            <img class="float-start me-3 mb-lg-0 mb-3" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($menu['image']); ?>" width="80" height="80" alt="">
                                            <div class="game-title-header">
                                                <p class="game-title fw-medium text-start color-palette-1 m-0"><?= $menu['name'] ?></p>
                                            </div>
                                        </th>
                                        <td>
                                            <p class="fw-medium color-palette-1 m-0" style="width: 200px;"><?= $menu['description'] ?></p>
                                        </td>
                                        <td>
                                            <p class="fw-medium text-start color-palette-1 m-0"><?= $menu['price'] ?></p>
                                        </td>
                                        <td>
                                            <a href="delete2.php?id=<?= $menu['id']; ?>" class="btn btn-primary">Delete</a>
